...
# ========================================================
# INTERCEPTADOR DE SINCRONICIDAD
# ========================================================
...
def interceptador_de_senales():
    """Módulo lateral para captura rápida de convergencia"""

    st.sidebar.markdown("### ⚡ Interceptador de Convergencia")

    with st.sidebar.expander("Registro Inmediato de Señal"):

        entrada_datos = st.text_input(
            "Ingresa vector (Ej: 7,11,4,3,8,5)"
        )

        slider_nivel = st.slider(
            "Nivel de Convergencia IA",
            min_value=0,
            max_value=100,
            value=50
        )
...
# ========================================================
# MÓDULO DE CONVERGENCIA SIGNALMAP IA
# ========================================================

def calcular_convergencia(secuencia, codigo_base, temperatura):
    """
    Índice de Convergencia:
    (Sumatoria de la secuencia × Código Base) / Temperatura
    """
